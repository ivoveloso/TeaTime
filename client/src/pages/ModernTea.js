        ...
        <div id="bg-modern-images" style={{ backgroundImage: `url("https://c1.wallpaperflare.com/path/681/578/434/matcha-power-japanese-ingredient-56baf6e0dcb0bfc443ebc7b24610003c.jpg")` }}>
            <nav class="navbar background">
                ...
                <div class="modernTeaitems">
                    <div class="tea-card" id="card1"><h5>ROSÉ RENDEZVOUS</h5>
                        <img src='https://www.ohhowcivilized.com/wp-content/uploads/rose-tea-5.jpg'></img>
                    </div>
                    <div class="tea-card" id="card2"><h5>CHRYSANTHEMUM SAMURAI</h5>
                    ...
                    <div class="tea-card" id="card3"><h5>LAVENDER DREAM</h5>
                    ...
                    <div class="tea-card" id="card4"><h5>SWEET OSMANTHUS</h5>
